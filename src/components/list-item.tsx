    ...
    return (
        <div className="flex items-start w-full gap-3 p-5 overflow-hidden shadow bg-gray-50/95 rounded-xl min-h-fit">
            ...
            <div className='flex flex-col items-start justify-between w-full overflow-hidden'>
                ...
                <p className="truncate xl:text-lg text-Gray-600">{description ?? <>No description!</>}</p>
            ...
            <div className='flex items-center justify-end gap-1 ml-auto w-fit sm:gap-3'>
                <Button onClick={handleUpdateListItem} className="w-fit !p-2 !bg-transparent">
                    <Edit />
                </Button>
                <Button onClick={handleDeleteListItem} className="w-fit !p-2 !bg-transparent !border-[#b91c1c]">
                    <Trash stroke="#b91c1c" />
                </Button>
            </div>
        </div>
